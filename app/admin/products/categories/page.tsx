...
export default function CategoriesPage() {
  ...
  const handleAddCategory = () => {
    ...
    setCategories([
      ...categories,
      { id: newId, name: newCategory.name, count: 0, type: newCategory.type },
    ]);
      ...
      <Card className="bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-800">
        <CardContent className="pt-6">
          <p className="text-amber-800 dark:text-amber-200 text-sm">
            <strong>Note:</strong> "Brand New" categories do not support
            subcategories. All products in the "Brand New" type will be listed
            together. Subcategories are only supported for "Imported Used"
            furniture.
          </p>
        </CardContent>
      </Card>
