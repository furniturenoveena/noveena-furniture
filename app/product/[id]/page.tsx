...
export default function ProductDetailPage({
  ...
  const selectedColorData =
    availableColors.find((color) => color.id === selectedColor) ||
    availableColors[0];
        ...
        >
          ...
          <div className="space-y-6">
                        ...
                        <ul className="text-sm space-y-1">
                          {product.tieredPricing.map((tier, index) => (
                            <li key={index} className="flex justify-between">
                              ...
                              <span>
                                Rs. {tier.price.toLocaleString()}/item
                              </span>
                            </li>
                          ))}
                        </ul>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="flex-1 font-montserrat transition-all duration-300 hover:scale-[1.02] py-2 lg:py-0"
              ...
              <Button
                size="lg"
                variant="outline"
                className="flex-1 font-montserrat transition-all duration-300 hover:bg-primary/5 py-2 lg:py-0"
