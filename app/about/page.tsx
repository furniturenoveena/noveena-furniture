...
export default function AboutPage() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section
        ref={heroRef}
        className="min-h-[80vh] flex items-center relative pt-24 pb-16 overflow-hidden"
      >
        ...
        <div className="absolute inset-0 z-0">
          ...
          <motion.div
            ...
            animate={
              heroInView ? { y: 0, opacity: 0.3 } : { y: -20, opacity: 0 }
            }
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              >
                Formerly known as homestar.lk, Noveena Furniture is dedicated to
                transforming living spaces with premium quality furniture that
                combines elegance, comfort, and durability.
              </motion.p>
              ...
              >
                {[
                  ...
                  <div key={index} className="text-center">
                    <div className="text-2xl md:text-3xl font-bold font-playfair text-primary">
                      {stat.value}
                    </div>
          ...
          >
            <span className="text-muted-foreground text-xs uppercase tracking-widest mb-2">
              Discover More
            </span>
            <motion.div
              animate={{
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                <Image
                  src="https://lh3.googleusercontent.com/p/AF1QipPFa4ZssDFrn1PFECOyvfifvq5EeuH-vGprruxJ=s1360-w1360-h1020-rw"
                  alt="Our Story"
                  fill
                  className="object-cover"
                />
              ...
              <motion.div
                ...
                animate={
                  storyInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }
                }
                transition={{ duration: 0.6, delay: 0.5 }}
              >
                <div className="flex items-center mb-3">
                  <div className="h-2 w-2 bg-primary rounded-full mr-2"></div>
                  <p className="text-sm font-medium">EST. 2005</p>
                </div>
                <p className="text-sm text-muted-foreground italic">
                  "We believe that furniture should tell a story and create a
                  sense of home."
                </p>
                <div className="mt-3 text-sm font-medium text-primary">
                  - Ravi Weeramanthrie, Founder
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our journey began with a simple passion for beautiful,
                      high-quality furniture. What started as homestar.lk has
                      now evolved into Noveena Furniture, a rebranded luxury
                      furniture store dedicated to providing exceptional pieces
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      From the beginning, we've been committed to sourcing the
                      finest furniture, whether it's imported used pieces with
                      character and history or brand new items designed with
                      contemporary aesthetics in mind. Each piece in our
                      collection is carefully selected to ensure the highest
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Over the years, we've built relationships with trusted
                      suppliers from around the world, allowing us to offer a
                      diverse range of furniture styles that cater to various
      ...
      <section ref={valuesRef} className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              At the core of Noveena Furniture are the values that drive
              everything we do. These principles guide our decisions and shape
            ...
            {[
              {
                ...
                title: "Quality",
                description:
                  "We never compromise on quality. Each piece of furniture in our collection meets our stringent standards for materials, construction, and design.",
              ...
              },
              {
                ...
                title: "Service",
                description:
                  "We believe in personalized service. Our team is dedicated to helping you find the perfect furniture pieces for your space.",
              ...
              },
              {
                ...
                title: "Excellence",
                description:
                  "We strive for excellence in everything we do, from curating our collection to delivery and after-sales service.",
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`${value.iconBg} h-16 w-16 rounded-xl flex items-center justify-center mb-6 relative z-10 group-hover:scale-110 transition-transform duration-300`}
                >
                  <div className="text-primary">{value.icon}</div>
                </div>

                {/* Content */}
                <h3 className="text-xl font-bold mb-3 font-cormorant relative z-10 group-hover:text-primary transition-colors duration-300">
                  {value.title}
                </h3>
      ...
      <section ref={teamRef} className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              The passionate people behind Noveena Furniture who work tirelessly
              to bring you the finest furniture collections.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 p-10 md:p-16 text-center">
              ...
              >
                ...
                >
                  Experience our furniture collection in person. Our team is
                  ready to assist you in finding the perfect pieces for your
                  home or office.
                </motion.p>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span>337 Kaduwela Road, Thalangama, Koswatta</span>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <motion.div variants={fadeUpItem} custom={4}>
                  <Button
                    asChild
                    size="lg"
