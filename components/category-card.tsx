...
export default function CategoryCard({ category }: CategoryCardProps) {
  // Need to check if this is a brand new category to avoid creating subcategory links
  const isBrandNew = category.name.toLowerCase().includes("brand new");
  const href = isBrandNew
    ? "/category/brand-new"
