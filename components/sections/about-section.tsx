          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground body-elegant">
              ...
              <p>
                ...
                character and history, as well as brand new pieces designed with
                contemporary aesthetics. Each item is carefully selected to
                ensure the highest standards of craftsmanship and design.
              </p>
              <p>
              ...
              >
                {[
                  ...
                  >
                    ...
                    <span className="text-sm font-medium relative z-10 tracking-wide group-hover:tracking-wider transition-all duration-500">
                      {value}
                    </span>
                  </motion.div>
                ))}
            ...
            >
              <div className="relative inline-flex group">
                ...
                >
                  ...
                  >
                    <span className="relative z-10 mr-1 group-hover:mr-3 transition-all duration-300">
                      Learn More About Us
                    </span>
              ...
              <div className="mt-6 flex items-center">
                ...
                <span className="text-xs text-muted-foreground ml-2 italic font-serif">
