        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Discover our exquisite collection of furniture crafted with precision and 
                designed to transform your living spaces into a statement of elegance and luxury.
              </motion.p>
              ...
              >
                ...
                >
                  <div className="font-bold text-sm">100+ Satisfied Clients</div>
                  <div className="text-xs text-muted-foreground">Join our satisfied customers</div>
                </motion.div>
              </motion.div>
            </motion.div>
