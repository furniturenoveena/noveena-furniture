    ...
    >
          ...
          <div className="relative w-full h-full">
            <Image
              ...
              style={{
                objectFit: "contain",
                objectPosition:
                  window.innerWidth < 640 ? "top center" : "center right",
                maxWidth: "100%",
              }}
              priority
      ...
      {[...Array(window.innerWidth < 640 ? 3 : 6)].map((_, i) => (
        <motion.div
          ...
          style={{
            x:
              mousePosition.x * (i + 1) * (window.innerWidth < 640 ? -10 : -20),
            y:
              mousePosition.y * (i + 1) * (window.innerWidth < 640 ? -10 : -20),
      ...
      <div className="container mx-auto px-5 sm:px-6 md:px-8 z-10">
        <motion.div style={{ y, opacity }} className="max-w-xl pt-20 sm:pt-0">
          ...
          >
            Discover our premium collection of imported and brand new furniture,
            meticulously curated to transform your home into a sanctuary of
