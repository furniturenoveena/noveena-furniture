...
import { motion, useInView, useMotionValue, useTransform, AnimatePresence, useScroll } from "framer-motion";
import { Truck, Award, ShieldCheck, ChevronRight, Star } from "lucide-react";

const FeatureCard = ({ icon: Icon, title, description, index, isHovered, onHover, scrollYProgress }) => {
  ...
  return (
    <motion.div
      ...
      className={`relative p-8 rounded-2xl backdrop-blur-sm transition-all duration-300 
                ${isHovered === index ? 'bg-primary/15 shadow-lg shadow-primary/20' : 'bg-primary/5 hover:bg-primary/10'}`}
      style={{ 
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          >
            <Icon 
              className={`h-10 w-10 ${isHovered === index ? 'text-white stroke-[2]' : 'text-primary stroke-[1.5]'}`} 
            />
          </motion.div>
        </motion.div>
  ...
  const features = [
    {
      ...
      description: "Complimentary premium delivery service for all furniture within Colombo and suburbs, with expert placement and setup by our trained specialists."
    },
    {
      icon: Award,
      title: "Curated Excellence",
      description: "Each piece in our collection is personally selected for exceptional quality, craftsmanship, and timeless design that elevates your living spaces."
    },
    {
      icon: ShieldCheck,
      title: "Quality Assurance",
      description: "Every furniture piece comes with our 2-year quality guarantee, ensuring lasting beauty and durability for years to come."
    }
  ];
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center">
            <div className="relative h-0.5 w-24 bg-gray-200/30 rounded-full overflow-hidden">
              <motion.div 
                ...
                style={{
                  width: useTransform(scrollYProgress, [0, 0.2, 0.3], ["0%", "0%", "100%"])
                }}
              />
            </div>
          </div>
          ...
          >
            We believe exceptional furniture transcends mere function to become an expression of personal style and aspiration. Our commitment to excellence touches every aspect of your experience.
          </motion.p>
        </div>
